...
<body background="black">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
		...
		<h2>NOTE: BOOKED SEATS ARE DISABLED</h2></center>
		<button onclick="window.location.href = 'payment.php';"><h5>Click here after selecting seats below!!</button>
  ...
  <br><br>
    <li class="row row--1"><br><br><br><br>
