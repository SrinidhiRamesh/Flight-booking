...
<body background="25.gif">
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
        <header class="mdl-layout__header" style="background-color:#E8F6EF;">
            <div class="mdl-layout__header-row" style="background-color:#E8F6EF;">
                <!-- Title -->
                <span class="mdl-layout-title" style="color:black;">Your Bookings</span>
        ...
        <div class="mdl-shadow--16dp" style="background-color:#E8F6EF;">
                        <br>
                        <div class="mdl-typography--title" style="color:black">Your Flights</div>
                        <br>
                        </div>
        <br><br>
...
<div class="mdl-shadow--16dp" style="background-color:#9BA4B5"><br>
                        <a class="mdl-navigation__link" href="front.php"><div class="mdl-typography--title" style="color:#000000;font-size:15px"><b>Go Back</b></div></a>
                        <br>
                        </div>
